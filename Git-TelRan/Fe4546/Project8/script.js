...
console.log(products[2].name, products[2].price )
  // products[2].name, price - price is not defined так не пишим

  // Вывести в консоль название в теге <h1><h1> // шаблонная строка 
console.log(`<h1>${products[1].name + " " + products[1].name}</h1>`) //интерполяция

// Вывести в консоли div, внутри которого в теге h1 отобразить название продукта, у которого id = 2,
// и внутри того же div'а в теге <p> отобразить цену того же продукта
console.log(`<div> <h1>${products[1].name}</h1> <p>${products[1].price}</p></div>`)


// Вывести в консоли div, внутри которого в теге h1 отобразить название продукта, у которого id = 1,
// и внутри того же div'а в теге <p> отобразить цену того же продукта
console.log(`<div> <h1>${products[0].name}</h1> <p>${products[0].price}</p></div>`)
console.log(` <div>
...
*/
    ...
    function showNotification(text, color){
        console.log(`Show notification ${text} color ${color}`)
    }
    showNotification("Your function is valid", "green")
    showNotification("Your function is invalid", "read")
